...
const GET = async ({ params }) => {
  if (!SUPABASE_URL || !SERVICE_KEY || params.id.startsWith("stub-")) {
    const map = {
      ...
      "stub-feed": { id: "stub-feed", sku: "FEED-50KG", name: "Layer Feed 50kg", category: "feed", price_naira: 18e3, unit: "sack", stock_qty: 40 },
      "stub-chicks": { id: "stub-chicks", sku: "CHICKS-20", name: "Starter Chicks (20)", category: "poultry", price_naira: 12e3, unit: "pack", stock_qty: 200 }
    };
